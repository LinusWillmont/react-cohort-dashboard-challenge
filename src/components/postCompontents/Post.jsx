        ...
        <div className="flex flex-col gap-5 border-b-2 border-bodyBackground">
          <div className="flex gap-5">
            ...
            <div className="flex flex-col justify-center">
              ...
              <Link className="text-gray" to={`../posts/${post.id}`}>
                {post.title}
              </Link>
            </div>
            <div className="ml-auto">
              <button
                className="bg-main hover:bg-hover  text-white rounded-lg px-6 py-2"
                onClick={handleEditPost}
              >
                Edit
              </button>
              <button
                className="bg-main hover:bg-hover  text-white rounded-lg px-6 py-2 ml-1"
                onClick={deletePost}
              >
                Delete
              </button>
